package saving_app.saving_goal.components;
...
public class SavingTipsBox extends VBox {
    ...
    private HBox createTitleSection() {
        try {
            ...
            Image icon = new Image(new FileInputStream("saving_app/saving_goal/resources/emoji2.png"));
    ...
    private ImageView createImageView(int index) {
        try {
            ...
            Image image = new Image(new FileInputStream("saving_app/saving_goal/resources/image" + (index + 1) + ".png"));
