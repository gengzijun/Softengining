...
public class MainPage {
    ...
    private Scene buildMainScene() {
        ...
        Button chartBtn = createIconButton("/saving_app/main/images/chart.png", "Chart", 20, 160, 20);
        Button detailsBtn = createIconButton("/saving_app/main/images/details.png", "Details", 20, 160, 20);
        Button historyBtn = createIconButton("/saving_app/main/images/history.png", "history", 32, 10, 10);
        ...
        Button exportBtn = createIconButton("/saving_app/main/images/export.png", "export", 32, 10, 10);
        exportBtn.setContentDisplay(ContentDisplay.GRAPHIC_ONLY);
        Button importBtn = createIconButton("/saving_app/main/images/import.png", "import", 32, 10, 10);
        importBtn.setContentDisplay(ContentDisplay.GRAPHIC_ONLY);
        warningLabel = createIconButton("/saving_app/main/images/warning.png", "warning", 32, 10, 10);
    ...
    private void updateTotalAndWarning() {
        ...
        if (total > MONTHLY_BUDGET) {
            Image image = new Image(getClass().getResourceAsStream("/saving_app/main/images/warning_red.png"));
            imageView = new ImageView(image);
        } else {
            Image image = new Image(getClass().getResourceAsStream("/saving_app/main/images/warning.png"));
            imageView = new ImageView(image);
        }
